...
describe('RepertoryRepository', () => {
  describe('Immutability (Deep Clone)', () => {
    it('should return a clone, preventing base mutation', () => {
      if (typeof RepertoryRepository.getItems === 'function') {
        const items = RepertoryRepository.getItems();
        if (items && items.length > 0) {
          items[0].label = 'HACKED';
          items[0].name = 'HACKED';
          
          const newItems = RepertoryRepository.getItems();
