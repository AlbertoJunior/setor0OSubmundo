...
export const CharacteristicType = Object.freeze({
  ...
  BONUS: {
    ...
    DAMAGE_PENALTY_FLAT: { id: 'bonus_penalidade_dano_fixo', system: 'system.bonus.penalidade_dano_fixa', label: "Penalidade_Dano_Fixa" },
  ...
  NOTES: {
    id: 'anotacoes',
    system: 'system.anotacoes',
  },
  MANEUVERS: {
    id: 'manobras',
    system: 'system.manobras',
  },
  OTHERS: {
    id: 'outros',
    system: 'system.outros',
  },
  EXPERIENCE: {
    id: 'experiencia',
